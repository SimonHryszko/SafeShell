...
def generate_commit_message():
    ...
    message = get_suggestions(get_diff())
    console.log(f"Suggestions: [bold]{message}[/bold]")

    c = Prompt.ask("Options: [underline2]r[/underline2]etry, [underline2]c[/underline2]ommmit, cop[underline2]y[/underline2]", choices=['r', 'c', 'y'], default="c")
